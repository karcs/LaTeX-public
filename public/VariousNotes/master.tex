...
\begin{remark}
    ...
    $$\bigsetmeet_{i\in I}{A_i^{\meet}}={\left(\Setjoin_{i\in I}{A_i}\right)}^{\meet} \textrm{ and } \bigsetmeet_{i\in I}{A_i^{\join}}={\left(\Setjoin_{i\in I}{A_i}\right)}^{\join}.$$
\end{remark}
...
\begin{lemma}[bounds for the limit point of a sequence]
    ...
    $$
    a\in {\left(\Setjoin_{i\in I}{\set{a_j}_{j \geq i}^{\meet}}\right)}^{\join}\setmeet{\left(\bigsetmeet_{i\in I}\set{a_j}_{j \geq i}^{\join}\right)}^{\meet}
    $$
...
\begin{proof}
    ...
    {\left(\Setjoin_{i\in I}{\set{a_j}_{j \geq i}^{\meet}}\right)}^{\join}\setmeet{\left(\bigsetmeet_{i\in I}\set{a_j}_{j \geq i}^{\join}\right)}^{\meet},
    $$
...
\begin{definition}[limes superior and inferior]
    ...
    $$
    \sup{\left(\Setjoin_{i\in I}{\set{a_j}_{j \geq i}^{\meet}}\right)}=\hat{N}
    $$
    or
    $$
    \inf{\left(\Setjoin_{i\in I}{\set{a_j}_{j \geq i}^{\meet}}\right)}=\check{N}
    $$
