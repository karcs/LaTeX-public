...
% commutator group
\def\commutatorgroup#1#2\in#3{\gen{\commutator{\cast#1\to\Set}{\cast#2\to\Set}}\in{\Sub#3}}
...
\def\set#1{\@ifnextchar[ {\@set{#1}}{\@set{#1}[\empty]}}
\def\@set#1[#2]{\ifx#2\empty\left\{#1\right\}\else\left\{#1:#2\right\}\fi}

% sequence or net notation
\def\seq#1{\@ifnextchar[{\@seq#1}{\@seq#1[\empty]}}
...
\def\cogen#1{\left\rangle#1\right\langle}

% generated substructure
\def\gen#1\in#2{\left\langle#1\right\rangle_{#2}} 
