\message{ !name(OnBorsukUlamsThoerem.tex)}\documentclass[10pt,a4paper]{article}
...
\message{ !name(OnBorsukUlamsThoerem.tex) !offset(-3) }
...
\end{document}
\message{ !name(OnBorsukUlamsThoerem.tex) !offset(-180) }
