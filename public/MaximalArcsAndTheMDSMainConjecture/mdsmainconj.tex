...
\begin{lemma}[connection between principally and totally regular matrices]
    Let $C\defeq(A|B)\in R^{m\setprod n}$ be some matrix over a commutative ring $R$ and $m\leq n$ where $A\in R^{m\setprod m}$.
